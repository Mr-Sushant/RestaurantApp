...
public class HashTag extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("HashTag");
    ...
    private void storeData(String fname, String lname, String review) {
        ...
        reference.push().setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                {
                    Toast.makeText(HashTag.this, "Review Submitted", Toast.LENGTH_SHORT).show();
                }
            }
        });
            ...
            uploadTask.continueWithTask(new Continuation< UploadTask.TaskSnapshot,Task<Uri> >() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    ...
                    if(task.isSuccessful()){
                        ...
                        Toast.makeText(HashTag.this, "Uploaded", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(HashTag.this,"Failed!",Toast.LENGTH_SHORT).show();
                        pd.dismiss();
                    }
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(HashTag.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                    pd.dismiss();
                }
            });

        }else{
            Toast.makeText(HashTag.this,"No Image Selected",Toast.LENGTH_SHORT).show();
        }
