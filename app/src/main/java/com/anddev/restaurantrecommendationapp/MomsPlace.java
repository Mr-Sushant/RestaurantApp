...
public class MomsPlace extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_moms_place2);

        firebaseUser = FirebaseAuth.getInstance().getCurrentUser();
        reference = FirebaseDatabase.getInstance().getReference().child("Mom's Place");
    ...
    private void storeData(String fname, String lname, String review) {
        ...
        reference.push().setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                {
                    Toast.makeText(MomsPlace.this, "Review Submitted", Toast.LENGTH_SHORT).show();
                }
            }
        });
            ...
            uploadTask.continueWithTask(new Continuation< UploadTask.TaskSnapshot,Task<Uri> >() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    ...
                    if(task.isSuccessful()){
                        ...
                        Toast.makeText(MomsPlace.this, "Uploaded", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(MomsPlace.this,"Failed!",Toast.LENGTH_SHORT).show();
                        pd.dismiss();
                    }
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(MomsPlace.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                    pd.dismiss();
                }
            });

        }else{
            Toast.makeText(MomsPlace.this,"No Image Selected",Toast.LENGTH_SHORT).show();
        }
