...
public class Joy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("Joy Restaurant");
    ...
    private void storeData(String fname, String lname, String review) {
        ...
        reference.push().setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                {
                    Toast.makeText(Joy.this, "Review Submitted", Toast.LENGTH_SHORT).show();
                }
            }
        });
            ...
            uploadTask.continueWithTask(new Continuation< UploadTask.TaskSnapshot,Task<Uri> >() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    ...
                    if(task.isSuccessful()){
                        ...
                        Toast.makeText(Joy.this, "Uploaded", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(Joy.this,"Failed!",Toast.LENGTH_SHORT).show();
                        pd.dismiss();
                    }
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(Joy.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                    pd.dismiss();
                }
            });

        }else{
            Toast.makeText(Joy.this,"No Image Selected",Toast.LENGTH_SHORT).show();
        }
