...
public class HookieDookie extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hookie_dookie);

        firebaseUser = FirebaseAuth.getInstance().getCurrentUser();
        reference = FirebaseDatabase.getInstance().getReference().child("Hookie Dookie");
    ...
    private void storeData(String fname, String lname, String review) {
        ...
        reference.push().setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                {
                    Toast.makeText(HookieDookie.this, "Review Submitted", Toast.LENGTH_SHORT).show();
                }
            }
        });
            ...
            uploadTask.continueWithTask(new Continuation< UploadTask.TaskSnapshot,Task<Uri> >() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    ...
                    if(task.isSuccessful()){
                        ...
                        Toast.makeText(HookieDookie.this, "Uploaded", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(HookieDookie.this,"Failed!",Toast.LENGTH_SHORT).show();
                        pd.dismiss();
                    }
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(HookieDookie.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                    pd.dismiss();
                }
            });

        }else{
            Toast.makeText(HookieDookie.this,"No Image Selected",Toast.LENGTH_SHORT).show();
        }
